...
inline bool CFG_GET_BOOL(const std::string& section, const std::string& key, const bool &default_value){ 
	return (bool)frpublic::SingleConfigurator::GetInstance()->GetInt(section, key, (int)default_value); 
}
inline bool CFG_GET_BOOL(const frpublic::Configurator::CfgKey& cfg_key, const std::string& section, const std::string& key, const bool &default_value){ 
	return (bool)frpublic::SingleConfigurator::GetInstance()->GetInt(cfg_key, section, key, (int)default_value); 
}

inline int CFG_GET_INT(const std::string& section, const std::string& key, const int &default_value){ 
	return frpublic::SingleConfigurator::GetInstance()->GetInt(section, key, default_value); 
}
inline int CFG_GET_INT(const frpublic::Configurator::CfgKey& cfg_key, const std::string& section, const std::string& key, const int &default_value){ 
	return frpublic::SingleConfigurator::GetInstance()->GetInt(cfg_key, section, key, default_value); 
}

inline double CFG_GET_DOUBLE(const std::string& section, const std::string& key, const double &default_value){ 
	return frpublic::SingleConfigurator::GetInstance()->GetDouble(section, key, default_value); 
}
inline double CFG_GET_DOUBLE(const frpublic::Configurator::CfgKey& cfg_key, const std::string& section, const std::string& key, const double &default_value){ 
	return frpublic::SingleConfigurator::GetInstance()->GetDouble(cfg_key, section, key, default_value); 
}

inline std::string CFG_GET_STRING(const std::string& section, const std::string& key, const std::string &default_value){ 
	return frpublic::SingleConfigurator::GetInstance()->GetString(section, key, default_value); 
}
inline std::string CFG_GET_STRING(const frpublic::Configurator::CfgKey& cfg_key, const std::string& section, const std::string& key, const std::string &default_value){ 
	return frpublic::SingleConfigurator::GetInstance()->GetString(cfg_key, section, key, default_value); 
}


inline bool CFG_SET_BOOL(const std::string& section, const std::string& key, bool value){ 
	if(frpublic::SingleConfigurator::GetInstance()->SetInt(section, key, (int)value)){
		frpublic::SingleConfigurator::GetInstance()->SaveCfg();
		return true;
	}
	return false; 
}
inline bool CFG_SET_BOOL(const frpublic::Configurator::CfgKey& cfg_key, const std::string& section, const std::string& key, bool value){ 
	if(frpublic::SingleConfigurator::GetInstance()->SetInt(cfg_key, section, key, (int)value)){
		frpublic::SingleConfigurator::GetInstance()->SaveCfg(cfg_key);
		return true;
	}
	return false; 
}
...
inline bool CFG_SET_INT(const std::string& section, const std::string& key, int value){ 
	if(frpublic::SingleConfigurator::GetInstance()->SetInt(section, key, value)){
		frpublic::SingleConfigurator::GetInstance()->SaveCfg();
		return true;
	}
	return false; 
}
inline bool CFG_SET_INT(const frpublic::Configurator::CfgKey& cfg_key, const std::string& section, const std::string& key, int value){ 
	if(frpublic::SingleConfigurator::GetInstance()->SetInt(cfg_key, section, key, value)){
		frpublic::SingleConfigurator::GetInstance()->SaveCfg(cfg_key);
		return true;
	}
	return false; 
...
inline bool CFG_SET_DOUBLE(const std::string& section, const std::string& key, double value){ 
	if(frpublic::SingleConfigurator::GetInstance()->SetDouble(section, key, value)){
		frpublic::SingleConfigurator::GetInstance()->SaveCfg();
		return true;
	}
	return false; 
}
inline bool CFG_SET_DOUBLE(const frpublic::Configurator::CfgKey& cfg_key, const std::string& section, const std::string& key, double value){ 
	if(frpublic::SingleConfigurator::GetInstance()->SetDouble(cfg_key, section, key, value)){
		frpublic::SingleConfigurator::GetInstance()->SaveCfg(cfg_key);
		return true;
	}
	return false; 
...
inline bool CFG_SET_STRING(const frpublic::Configurator::CfgKey& cfg_key, const std::string& section, const std::string& key, const std::string &value){ 
