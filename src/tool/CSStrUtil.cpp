/**********************************************************
 * \file source/tool/CSStrUtil.cpp
 * \brief 
 * \note 
 * 
 * \version 
...
namespace Universal{
	...
	void convertFullToHalf( string &str, eCSCharacterEncoding encoding ){
	...
	void convertHalfToFull( string &str, eCSCharacterEncoding encoding ){
		ConvertToUtf8( str, encoding );
	...
	size_t getStrSize( const string &str, eCSCharacterEncoding encoding ){
		if( !str.empty() ){
			size_t size = 0;
